...
class FlaskUI:
    ...
    def __init__(self, app=None, width=800, height=600, fullscreen=False, maximized=False, app_mode=True,  browser_path="", server="flask", host="127.0.0.1", port=5000, socketio=None, on_exit=None, url_suffix=""):
        self.flask_app = app
        ...
        self.localhost = "http://{}:{}/{}".format(host, port, url_suffix) # http://127.0.0.1:5000/
